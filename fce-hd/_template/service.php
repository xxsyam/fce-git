...
<head>
  ...
  <link rel="stylesheet" href="/bin/css/service.min.css">
...
<body id="body">
  ...
  <main class="wrapper">
    ...
    <!-- メインビジュアル -->
    <div class="main-visual bg-animation anim bl">
      <div class="inner">
    ...
    <!-- Inner Heading -->
    <section class="servie_list inner anim inview">

      <h3 class="heading anim inview">社会の課題にビジネスで挑む。</h3>
      ...
      <nav class="inview">
        <ul class="category_nav anim-list">
          ...
          <li><a href="">#出版</a></li>
          <li><a href="">#ストアビジネス</a></li>
        </ul>
      </nav>

      <article class="list_wrapper">
        <div class="anim inview">
          <ul class="anim-list list_wrap">
            <li>
              <a href="#" class="hover-effect">
                <h4><strong>全国の学校や学習塾で子供たちが学ぶ</strong><span>『7つの習慣J』／FCEエデュケーション</span></h4>
                <div class="list_body">
                  <figure class="hover-img">
                    <img src="/bin/image/face1.png" alt="">
                  </figure>
                  <div class="text_wrap">
                    <p>小学生〜広告・専門学生を対象に、生徒・学生の主体性を引き出し、問題発見能力、問題解決能力を育む授業プログラム。</p>
                  </div>
                </div>
              </a>
            </li>
