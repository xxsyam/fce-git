...
<body id="body">
  ...
  <main class="wrapper history">

    <!-- メインビジュアル -->
    <div class="main-visual bg-animation anim rd">
      <div class="inner">
        <h2 class="sub_heading">ABOUT<small>FCEグループとは</small></h2>
        <h2 class="heading">History<small>チャレンジの歩み</small></h2>
        <div class="breadcrumb">
          <a href="#">HOME</a> ＞ <a href="./about.php">ABOUT</a> ＞ History
        </div>
      </div>
      <div class="main-bg">
    ...
    <!-- Mission -->
    <section class="inner anim">

      <h2 class="heading">History<small>チャレンジの歩み</small></h2>

      <div class="anim">
        <dl class="spoint_wrap parent_data">
          <dt>2004.02</dt>
          <dd>
            <h3>タイトルタイトル.....</h3>
            ...
            <div class="pict_wraps one right"><img src="/bin/image/service_1.png"></div>
          </dd>
        </dl>
        <dl class="spoint_wrap parent_data">
          <dt>2004.02</dt>
          <dd>
            ...
            <p>ダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキスト</p>
            <p>ダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキスト</p>
            <div class="pict_wraps two"><img src="/bin/image/service_1.png"><img src="/bin/image/service_1.png"></div>
          </dd>
        </dl>
        <dl class="spoint_wrap parent_data">
          <dt>2004.02</dt>
          <dd>
            ...
            <p>ダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキスト</p>
            <p>ダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキスト</p>
            <div class="pict_wraps three"><img src="/bin/image/service_1.png"><img src="/bin/image/service_1.png"><img src="/bin/image/service_1.png"></div>
          </dd>
        </dl>
