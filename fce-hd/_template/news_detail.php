...
<head>
  ...
  <link rel="stylesheet" href="/bin/css/news.min.css">
...
<body id="body">
  ...
  <main class="wrapper">
    ...
    <!-- Inner Heading -->
    <section class="news_detail inner anim inview">

      <article class="list_wrapper inner">
        <div class="anim inview inner">
          <h3>600社以上のリモートワーク導入成功実績！クロスリバー社越川氏による「withコロナの働き方プログラム」「リモートワーク7つの管理手法講座」動画教材を販売開始</h3>
          <ul class="category_list">
            <li><a href="#">プレスリリース</a></li>
          </ul>
          <time>2018.02.16</time>

          <div class="eyecatch"><img src="/bin/image/img_1.png"></div>

          <div class="content_field">
            <p>人材育成事業を行う株式会社FCEトレーニング・カンパニー（本社：東京都新宿区 代表取締役：荻野純子）は、働き方改革アドバイザー等成長企業支援事業を行う株式会社クロスリバー（本社：東京都港区　代表取締役：越川慎司）と提携し、元マイクロソフト業務執行役員でOffice事業の責任者も務めた越川氏による動画教材「withコロナの働き方プログラム」シリーズ「目指すべきは儲け方改革～働き方改革をチャンスにする講座～」全10講座と「リモートワークを成功に導く７つの管理手法講座」を販売開始いたします。本動画はFCEトレーニング・カンパニー運営の定額制オンライントレーニング「Smart Boardingプレミアムコース」内で配信される他、企業内E-ラーニングやLMS用に「動画教材単体」としても販売。withコロナ時代における企業活動の促進、社員の働きがい向上のための教材を提供いたします。</p>

            <dl>
              <dt>プレスリリース</dt>
              <dd><a href="https://www.value-press.com/pressrelease/244672" target="_blank">https://www.value-press.com/pressrelease/244672</a></dd>
            </dl>
          </div>
        </div>
      </article>

      <div class="pagination nextprev_type">
        <ul class="pagination-box"><li><a href="/page/2/">‹</a></li><li><a href="/page/4/">›</a></li></ul>
      </div>

      <div class="button">
        <a href="./news.php">新着記事一覧へ</a>
      </div>
