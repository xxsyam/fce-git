...
<body id="body">
  ...
  <main class="wrapper starting_point">

    <!-- メインビジュアル -->
    <div class="main-visual bg-animation anim rd">
      <div class="inner">
        <h2 class="sub_heading">ABOUT<small>FCEグループとは</small></h2>
        <h2 class="heading">Starting Point<small>チャレンジはここからはじまった</small></h2>
        <div class="breadcrumb">
          <a href="#">HOME</a> ＞ <a href="./about.php">ABOUT</a> ＞ Starting Point
        </div>
      </div>
      <div class="main-bg">
    ...
    <section class="inner anim">
      ...
      <div class="anim">
        ...
        <dl class="spoint_wrap sub_sub_data">
          <dt>2004.02</dt>
          <dd>
            <h3>すべては1冊の本との出会いから。</h3>
            <p>ダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキストダミーテキスト</p>
