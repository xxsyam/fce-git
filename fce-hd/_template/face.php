...
<body id="body">
  ...
  <main class="wrapper">
    ...
    <!-- Pick up -->
    <section class="pickup inner anim">

      <h2 class="heading">Pick up<small>おすすめ記事</small></h2>
    ...
    <section class="articles inner anim">
      ...
      <h2 class="heading">Articles<small>新着記事</small></h2>
