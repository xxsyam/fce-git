...
$Referer_check_domain = "https://fce-group.jp/recruit/";
...
$require = array('エントリー','お名前（全角）','お名前（フリガナ）','学校名・企業名（全角）','学校名・企業名（フリガナ）','生年月日','性別','Email','Email2','電話番号','興味のある事業や仕事内容','志望動機や職務経歴/お問い合わせ内容');
...
$re_subject = "採用についてお問い合わせありがとうございました";
...
Tel：03-5908-1409 Fax：03-5908-1401
...
//配列の形「name="○○[]"」の場合には必ず後ろの[]を取ったものを指定して下さい。
$hankaku_array = array('電話番号','Email','Email2');
